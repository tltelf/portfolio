...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
  ...
  return (
    ...
    >
      <div
        className=' bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] sm:group-odd:pl-8 dark:text-white hover:bg-gray-200 transition dark:bg-white/10 dark:hover:bg-white/20'
      >
